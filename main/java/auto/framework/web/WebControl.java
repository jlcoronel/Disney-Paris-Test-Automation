...
//        	ReportLog.attachScreenshot("screenshot", tmpFile.toURI().toURL().toString());
...
//		ReportLog.addInfo("Page Timeout set to 15 seconds.");
   ...
   //koro 7/25
   public static void scrollToObjName (String objName){
	    AndroidDriver<WebElement> driver = (AndroidDriver<WebElement>) WebManager.getDriver();
   ...
   public static void nativeDropDownClick(String value) {
	    AndroidDriver<WebElement> driver = (AndroidDriver<WebElement>) WebManager.getDriver();
		WebManager.androidDriver.context("NATIVE_APP");
		scrollToObjName(value);
//		driver.scrollTo(value);
	    driver.findElement(By.name(value)).click();
		WebManager.androidDriver.context("WEBVIEW_1");
